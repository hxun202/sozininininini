public class Circle
{
    ...
    ~Circle()
    {
        Console.WriteLine("Destroyed Circle");
    }
}
...
internal class Program
    ...
    static void Collide(Circle origin, Circle other)
    {
        ...
        if (deltaX*deltaX + deltaY * deltaY <= (origin.radius + other.radius) * (origin.radius + other.radius))
        {
    ...
    static void Main(string[] args)
        ...
        // Compact : Sweep 이후에 분산된 객체들을 관리되는 힙 영역의
        //                시작 주소로 모아 메모리가 할당된 부분과 그렇지 않은
        //                부분을 압축합니다.
